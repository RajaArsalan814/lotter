...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 23, 2023 at 01:44 PM
...
INSERT INTO `lottery_places` (`id`, `lottery_id`, `user_id`, `number_select`, `quantity`, `created_at`, `updated_at`) VALUES
(49, 1, 15, 3, 1, '2023-08-22 11:38:43', '2023-08-22 11:38:43'),
(50, 1, 15, 4, 4, '2023-08-22 11:38:43', '2023-08-22 11:38:43');
...
INSERT INTO `lottery_sets` (`id`, `lottery_id`, `start_date`, `end_date`, `created_at`, `updated_at`) VALUES
(3, 1, '10:00:00', '17:00:00', '2023-08-15 04:27:33', '2023-08-15 04:27:33'),
(6, 1, '20:00:00', '22:00:00', '2023-08-15 05:24:31', '2023-08-15 05:24:31');
...
CREATE TABLE `settings` (
  ...
  `home_page_heading` varchar(255) DEFAULT NULL,
  `home_page_sub_heading` varchar(255) DEFAULT NULL,
  `home_page_header_image` varchar(255) DEFAULT NULL,
  `home_page_background_image` varchar(255) DEFAULT NULL,
  `home_page_body_image` varchar(255) DEFAULT NULL,
...
(10, 'Gareth', 'Townsend', 'rududo@mailinator.com', '006', NULL, '$2y$10$bKJWNGMLRk11C35JaGWizej..LUkrH5bQ/gz72Q3oERbNtmscLqg6', 'default.png', 'Users', 'user', 1, 1, NULL, NULL, NULL, '2023-08-04 05:43:53', '2023-08-04 05:43:53'),
